        ...
        if len(args) >= 1:
            ...
            buttons = InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(
                            text="🙋 Support Group", url="https://t.me/LyndaEagleSupport"
                        ),
                        InlineKeyboardButton(
                            text="🚫 Global Logs", url="https://t.me/LyndaGLogs"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                            text="❔ Help", url="https://t.me/LyndaRobot?start=help"
                        ),
                        InlineKeyboardButton(
                            text="🔔 Update Channel", url="https://t.me/LyndaUpdateLogs"
                        ),
                    ],
                ]
            )
